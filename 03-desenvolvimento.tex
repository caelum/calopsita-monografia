...
Métodos tradicionais prezam pelo conhecido ``Big Design Up Front'' -- declaradamente, como no modelo \textit{Waterfall} ou de forma disfarçada como se vê nas inúmeras empresas que usam RUP no mercado.
